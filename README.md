...
```bash
composer require diogodg/asaas-sdk
```
...
Please see [CONTRIBUTING](https://github.com/diogodg/asaas-sdk/blob/master/CONTRIBUTING.md) for details.
...
[Para reportar um novo bug por favor abra um novo Issue no github](https://github.com/diogodg/asaas-sdk/issues)


## Support

###### Security: If you discover any security related issues, please email contato@diogodg.com instead of using the issue tracker.

Se você descobrir algum problema relacionado à segurança, envie um e-mail para contato@diogodg.com em vez de usar o rastreador de problemas.

Thank you

## Credits

- [Max Alex](https://github.com/diogodg) (Developer)
- [All Contributors](https://github.com/diogodg/asaas-sdk/contributors) (This Rock)

## License

The MIT License (MIT). Please see [License File](https://github.com/diogodg/asaas-sdk/blob/master/LICENSE) for more information.
